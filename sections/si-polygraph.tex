...
\begin{frame}{Polygraphs: A Family of Dependency Graphs}
	...
	\begin{center}
		polygraph: $C = \bset{\tuple{\eithervar \triangleq T_{k} \rel{\WW} T_{i},
...
%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Polygraphs: A Family of Dependency Graphs}
	\fig{width = 0.20\textwidth}{figs/g-polygraph-history}
	\pause
	\begin{columns}
		\column{0.50\textwidth}
			\fig{width = 0.50\textwidth}{figs/g-polygraph-T-S}
		\column{0.50\textwidth}
		  \pause
			\fig{width = 0.50\textwidth}{figs/g-polygraph-S-T}
	\end{columns}
	\pause
	\fig{width = 0.25\textwidth}{figs/g-polygraph}
	\begin{center}
		generalized polygraph:
		$C = \set{\tuple{\eithervar \triangleq \set{T_{k} \rel{\WW} T_{i}},
		  \orvar \triangleq \set{T_{j} \rel{\RW} T_{k}}}}$
	\end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%