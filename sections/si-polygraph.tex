...
\begin{frame}{Dependency Graph-based Characterization of SI}
  \begin{center}
		...
		\pause
		\vspace{0.80cm}
		\blue{$\mathcal{A}:$ encode them into SAT formulas based on (generalized) polygraphs}
  \end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Generalized Polygraphs: A Family of Dependency Graphs}
	\begin{columns}[c]
		\column{0.50\textwidth}
			\begin{center}
...
\begin{frame}{\textsc{PolySI}: An Illustrating Example of ``Long Fork''}
	\begin{center}
		...
		\resizebox{0.90\textwidth}{!}{\input{tikz/polysi-alg-encoding-tikz}}
		\uncover<4->{
			\[
...
\begin{frame}{\textsc{PolySI}: An Illustrating Example of ``Long Fork''}
	\begin{center}
		\fig{width = 0.60\textwidth}{figs/polysi-alg-cycle}
